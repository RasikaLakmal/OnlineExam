...
<div class="nav-side-menu">
 ...
 <div id="page-wrapper">
    <div class="row">
        ...
        <div class="border"><span>Exams</span></div><div><a href="/tsexams/{id}" type="button" class="btn btn-success ">New Exam</a></div>
      ...
      <th scope="col">Status</th>
        ...
        @foreach($examt as $user)
            ...
            <td scope="row"><a href="/tsexams/{id}" target="_blank">{{$user->exam_id}}</a></td>
