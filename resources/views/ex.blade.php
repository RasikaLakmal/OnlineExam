...
<div class="y">@foreach($d as $user)<a type="button" class="btn btn-info " href="{{route('answeringe',$user->id)}}" >Save</a>@endforeach<button class="btn btn-primary"  >Complete</button></div>
</div></div></div></form>
@endforeach
